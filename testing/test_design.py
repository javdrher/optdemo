...
class _DesignTests(unittest.TestCase):
    ...
    def setUp(self):
        self.domain = np.sum([OptDemo.domain.ContinuousParameter("x{0}".format(i), -i, 2*i) for i in range(1,4)])
...
class TestRandomDesign(_DesignTests):
    ...
    def setUp(self):
        ...
        self.design = OptDemo.design.RandomDesign(200, self.domain)
...
class TestEmptyDesign(_DesignTests):
    ...
    def setUp(self):
        ...
        self.design = OptDemo.design.EmptyDesign(self.domain)
...
class TestFactorialDesign(_DesignTests):
    ...
    def setUp(self):
        ...
        self.design = OptDemo.design.FactorialDesign(4, self.domain)
